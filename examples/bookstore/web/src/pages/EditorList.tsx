   ...
   return (
      <div>
         <Group justify="space-between" mb="md">
            <Title order={2}>Editors</Title>
            <Button onClick={() => navigate('/editors/new')}>Create Editor</Button>
         </Group>
         <Table>
            <Table.Thead>
               <Table.Tr>
            ...
            <Table.Tbody>
               {data.map(item => (
                  <Table.Tr key={item.uid}>
                     ...
                     <Table.Td>
                        <Group>
                           <Button size="xs" variant="outline" onClick={() => navigate(`/editors/${item.uid}`)}>Edit</Button>
